...
// Reference: https://www.telecomitalia.com/tit/it/innovazione/cybersecurity/red-team.html
// PoC Author: Francesco Giordano 
// Researchers: Francesco Giordano, Alessandro Sabetta (Red Team TIM Research)
...
func main() {
	...
	//first request needed to start the login challenge
...
//Build a multipart request without payload in filename
